...
export default async function Footer() {
  ...
  const whatsappNumber =
    settings?.whatsapp_number || "6282227427004";

  const phoneNumber =
    settings?.phone_number || "0822-2742-7004";
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#071120] py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-gray-300">
            Kirim foto, perkiraan ukuran, dan lokasi Anda. Kami
            siap membantu memberikan rekomendasi pengerjaan yang
            sesuai.
          </p>
      ...
      <footer
        id="kontak"
        className="bg-[#0d1728] pb-10 pt-16 text-gray-300"
      >
          ...
          <div>
            ...
            >
              ...
              <span className="text-2xl font-extrabold text-white">
                TukangLas.
                <span className="text-[#ff671d]">org</span>
              </span>
            </a>

            <p className="mt-5 max-w-md leading-7 text-gray-400">
              Jasa las panggilan untuk pembuatan dan perbaikan
              kanopi, pagar, teralis, railing, tangga besi,
              konstruksi baja, serta berbagai pekerjaan las
              custom.
            </p>
          </div>
            ...
            <div className="mt-5 space-y-4">
              ...
              {settings?.telegram_url && (
                <a
                  ...
                  className="flex items-center gap-3 transition hover:text-[#ff671d]"
                >
                  <Send size={21} className="shrink-0" />
                  Telegram
                </a>
              )}
              ...
              {settings?.email && (
                <a
                  ...
                  className="flex items-center gap-3 break-all transition hover:text-[#ff671d]"
                >
                  <Mail size={21} className="shrink-0" />
                  {settings.email}
                </a>
              )}
              ...
              <p>
                Jam operasional: Hubungi melalui WhatsApp
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto mt-12 max-w-[1560px] border-t border-white/10 px-5 pt-7 text-center text-sm text-gray-500 lg:px-10">
          © 2026 TukangLas.org. Seluruh hak cipta
          dilindungi.
        </div>
      </footer>
    </>
